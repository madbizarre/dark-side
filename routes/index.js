    ...
    let sendReviews = [
        {
            ...
            list: ['http://www.купить-кератин.рф', 'За 4 дня изготовлен сайт и наполнен товаром.', 'После настройки Директа получили настоящий поток заявок', 'Контекстная реклама', 'Таргетированная реклама']
        }, {
            ...
            title: 'Туристическое агенство КонТурБалт',
            img: 'img/review/tour-konturbalt.jpg',
            list: ['http://tour.konturbalt.ru/', 'Срочное изготовление Landing Page с индивидуальным дизайном и версткой за 4 дня']
        }, {
            title: 'Агенство «Ставръ-недвижимость»',
            img: 'img/review/stavr.jpg',
            list: ['http://ставрь.рф/', 'Изготовление лэндинга', 'Рекламные кампании', 'Google Awords', 'Яндекс Директ']
        }];
